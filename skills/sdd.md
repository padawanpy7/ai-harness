...
**controlado** (no "goal mode / andá y hacé todo"): cada fase es una compuerta. La IA es
...
1. **proposal** (lead): busca specs y codigo relevante; escribe que cambia y por que.
...
7. **archive**: la spec queda checkeada en el repo como documentacion viviente.

Calibrá antes de codear (SDD init): que existe, que specs hay, que convenciones. Recien
ahi proponé.
