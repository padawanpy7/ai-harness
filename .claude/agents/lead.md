...
2. Para cambios no triviales seguí **SDD** (skill `sdd`): proposal → design → tasks en
   `openspec/changes/<id>/`, y **frená en la compuerta de revisión humana** antes de codear.
   Para algo chico, un plan corto en `work/<tarea>.md` alcanza.
